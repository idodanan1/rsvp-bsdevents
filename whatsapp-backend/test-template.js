...
async function sendTemplateMessage() {
  console.log('🧪 שולח הודעת Template...');
  ...
  try {
    ...
    // Send message with template "a" (custom template)
    ...
    console.log('');
    console.log('🎉 ההודעה נשלחה עם Template!');
    console.log('📱 Message ID:', response.data.messages?.[0]?.id || 'N/A');
    console.log('');
    console.log('💡 עכשיו, אחרי שהמספר קיבל את ההודעה הראשונה, אפשר לשלוח הודעות טקסט חופשיות');
